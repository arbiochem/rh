...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 124, ; uint32_t number_of_assemblies_in_apk
	i32 0, ; uint32_t bundled_assembly_name_width
	i32 28, ; uint32_t number_of_dso_cache_entries
	i32 810, ; uint32_t number_of_aot_cache_entries
	i32 97, ; uint32_t number_of_shared_libraries
	i32 u0x020002c5, ; uint32_t android_runtime_jnienv_class_token
	i32 u0x06001af1, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001af0, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [810 x %struct.DSOCacheEntry] [
	%struct.DSOCacheEntry {
		i64 u0x003beba4753b78eb, ; from name: libaot-System.Net.NameResolution
		i64 u0x7f280e9be5453eba, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.69_name, ; name: libaot-System.Net.NameResolution.dll.so
		ptr null; void* handle
	}, ; 0
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.87_name, ; name: libaot-System.Threading.Channels.dll.so
		ptr null; void* handle
	}, ; 2
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.95_name, ; name: libaot-Mono.Android.dll.so
		ptr null; void* handle
	}, ; 4
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.74_name, ; name: libaot-System.Net.Sockets.dll.so
		ptr null; void* handle
	}, ; 5
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.96_name, ; name: libaot-System.Private.CoreLib.dll.so
		ptr null; void* handle
	}, ; 23
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x07cd5238b9f113bb, ; from name: app_commercial.so
		i64 u0x701f13bc17a0ec69, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-app_commercial.dll.so
		ptr null; void* handle
	}, ; 31
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.70_name, ; name: libaot-System.Net.NetworkInformation.dll.so
		ptr null; void* handle
	}, ; 48
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.94_name, ; name: libaot-Mono.Android.Runtime.dll.so
		ptr null; void* handle
	}, ; 62
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.73_name, ; name: libaot-System.Net.Security.dll.so
		ptr null; void* handle
	}, ; 74
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x39962a857065e590, ; from name: app_commercial
		i64 u0x701f13bc17a0ec69, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-app_commercial.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x3aad7c7c82e43c1f, ; from name: aot-app_commercial.so
		i64 u0x701f13bc17a0ec69, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-app_commercial.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.93_name, ; name: libaot-Java.Interop.dll.so
		ptr null; void* handle
	}, ; 212
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x701f13bc17a0ec69, ; from name: libaot-app_commercial.dll.so
		i64 u0x701f13bc17a0ec69, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-app_commercial.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xa27660c653d84b5f, ; from name: app_commercial.dll.so
		i64 u0x701f13bc17a0ec69, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-app_commercial.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xa5ad382011971b56, ; from name: libaot-app_commercial.so
		i64 u0x701f13bc17a0ec69, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-app_commercial.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc2d93a1610b8ccc8, ; from name: aot-app_commercial
		i64 u0x701f13bc17a0ec69, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-app_commercial.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xd55aa2299f533392, ; from name: aot-app_commercial.dll.so
		i64 u0x701f13bc17a0ec69, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-app_commercial.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xea87dcabd59d4408, ; from name: libaot-app_commercial
		i64 u0x701f13bc17a0ec69, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-app_commercial.dll.so
		ptr null; void* handle
...
@dso_apk_entries = dso_local local_unnamed_addr global [97 x %struct.DSOApkEntry] zeroinitializer, align 16
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [124 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 8
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [31 x i8] c"com.companyname.app_commercial\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [29 x i8] c"libaot-app_commercial.dll.so\00", align 16
...
@.DSOCacheEntry.69_name = private unnamed_addr constant [40 x i8] c"libaot-System.Net.NameResolution.dll.so\00", align 16
@.DSOCacheEntry.70_name = private unnamed_addr constant [44 x i8] c"libaot-System.Net.NetworkInformation.dll.so\00", align 16
...
@.DSOCacheEntry.73_name = private unnamed_addr constant [34 x i8] c"libaot-System.Net.Security.dll.so\00", align 16
@.DSOCacheEntry.74_name = private unnamed_addr constant [33 x i8] c"libaot-System.Net.Sockets.dll.so\00", align 16
...
@.DSOCacheEntry.87_name = private unnamed_addr constant [40 x i8] c"libaot-System.Threading.Channels.dll.so\00", align 16
...
@.DSOCacheEntry.93_name = private unnamed_addr constant [27 x i8] c"libaot-Java.Interop.dll.so\00", align 16
@.DSOCacheEntry.94_name = private unnamed_addr constant [35 x i8] c"libaot-Mono.Android.Runtime.dll.so\00", align 16
@.DSOCacheEntry.95_name = private unnamed_addr constant [27 x i8] c"libaot-Mono.Android.dll.so\00", align 16
@.DSOCacheEntry.96_name = private unnamed_addr constant [37 x i8] c"libaot-System.Private.CoreLib.dll.so\00", align 16
